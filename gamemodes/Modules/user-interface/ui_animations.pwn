...
CMD:e(playerid, aname[])
{
	if(isnull(aname))
	{
		ShowTDN(playerid, NOTIFICATION_SYNTAX, "/e [nama animasi]");
		return 1;
	}
	...
	if(AccountData[playerid][pSpawned] == 1){
		OnPlayerApplyAnimation(playerid, aname);
	}
	return 1;
}
